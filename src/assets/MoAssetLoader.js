...
import moPortraitUrl from './characters/special/mo/face-front.png?url'

export const MO_EXPRESSIONS = Object.freeze({
  idle: moPortraitUrl,
  smile: moPortraitUrl,
  suspect: moPortraitUrl,
  worried: moPortraitUrl,
  surprised: moPortraitUrl,
  sad: moPortraitUrl,
})
...
/**
 * Mơ's world model is fully procedural. This loader now owns dialogue
 * portraits only, so the three large world-face textures are not preloaded.
 */
export class MoAssetLoader {
  constructor({ textureLoader = null, assets = MO_EXPRESSIONS } = {}) {
