...
const OUTDOOR = Object.freeze({
  ...
  dawn: state({
    ...
    hemisphereSky: 0xaebfd0,
    hemisphereGround: 0x65564e,
    hemisphereIntensity: 1.02,
    directional: 0xffbd82,
  ...
  goldenHour: state({
    ...
    hemisphereSky: 0xc9bfba,
    hemisphereGround: 0x665c4e,
    hemisphereIntensity: 1.12,
    directional: 0xffb35f,
    directionalIntensity: 1.68,
    rim: 0xffc77d,
    rimIntensity: 0.62,
    practicalScale: 0.22,
    emissiveScale: 0.64,
  ...
  sunset: state({
    ...
    hemisphereSky: 0x9290a8,
    hemisphereGround: 0x52514c,
    hemisphereIntensity: 1.02,
    directional: 0xff8d5f,
  ...
  blueHour: state({
    ...
    hemisphereSky: 0x607da6,
    hemisphereGround: 0x3f3735,
