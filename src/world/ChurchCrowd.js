...
export class ChurchCrowd {
  ...
  #buildAmbientCast() {
    ...
    // Extra ambient NPCs for liveliness
    this.#actor({
      preset: 'officeWorker',
    ...
    this.#actor({
      preset: 'middleAged',
      name: 'Người đi bộ buổi chiều',
      behavior: 'walker',
      position: [15, 0, 5.5],
      waypoints: [[15, 0, 5.5], [-15, 0, 5.5]],
      animationOffset: 3.8,
      colliderRadius: 0.19,
    }, { role: 'ambientBusy' })
    this.#actor({
    ...
    this.#actor({
      preset: 'student',
      name: 'Sinh viên đọc sách',
      behavior: 'seated',
      position: [5, 0.36, 0.95],
      rotationY: Math.PI,
      collides: false,
      animationOffset: 2.9,
    }, { role: 'ambientDay' })
